...
new #[Title('Edit Supplier')] class extends Component {
    ...
    public function mount(Supplier $supplier): void
    {
        ...
        $this->pan_number = $supplier->pan_number ?? '';
        $this->country = $supplier->country ?? 'India';
        $this->state = $supplier->state ?? 'Gujarat';
    ...
    public function save(): void
    {
        ...
        Flux::toast(__('Supplier updated successfully.'));
...
<div class="flex h-full w-full flex-1 flex-col gap-4 max-w-2xl py-6">
    <div class="flex items-center gap-2">
        ...
        <flux:heading size="xl">{{ __('Edit Supplier') }}</flux:heading>
    </div>
    ...
    <flux:card>
        <form wire:submit="save" class="space-y-6">
            ...
            <div class="flex gap-2 pt-4">
                ...
                <flux:button type="submit" variant="primary">{{ __('Update Supplier') }}</flux:button>
            </div>
        </form>
    </flux:card>
</div>
