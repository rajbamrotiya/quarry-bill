...
<div class="flex h-full w-full flex-1 flex-col gap-4">
    ...
    <div class="flex items-center gap-4">
        <flux:input wire:model.live.debounce.300ms="search" icon="magnifying-glass" :placeholder="__('Search clients...')" class="max-w-xs" />
    </div>
    ...
    <flux:card class="overflow-hidden p-0">
        <flux:table :paginate="$this->clients">
            <flux:table.columns>
                ...
                <flux:table.column>{{ __('Mobile Number') }}</flux:table.column>
