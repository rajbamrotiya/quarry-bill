...
new #[Title('Create Client')] class extends Component {
    ...
    public function save(): void
    {
        ...
        Flux::toast(__('Client created successfully.'));
...
<div class="flex h-full w-full flex-1 flex-col gap-4 max-w-2xl py-6">
    <div class="flex items-center gap-2">
        ...
        <flux:heading size="xl">{{ __('Create Client') }}</flux:heading>
    </div>
        ...
        <form wire:submit="save" class="space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <flux:field class="md:col-span-2">
                    ...
                    <flux:textarea wire:model="address" :placeholder="__('Enter client address')" />
