...
new #[Title('New Work Receipt')] class extends Component {
    ...
    public function fetchTareWeight(): void
    {
        ...
        $lastReceipt = Receipt::where('vehicle_number', $this->vehicle_number)
            ->latest('id')
            ->first();
    ...
    public function nextPassNumber()
    {
        ...
        $lastReceipt = \App\Models\Receipt::where('pass_number', 'like', $prefix.'%')
    ...
    public function createClient(): void
    {
        $this->validateOnly('new_client_name', [
            'new_client_name' => 'required|string|max:255|unique:clients,name',
    ...
    <div class="space-y-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <flux:field>
                ...
                <flux:input wire:model="vehicle_number" wire:change="fetchTareWeight" :placeholder="__('e.g. GJ-01-XX-0000')" list="vehicle-numbers-list" class="bg-blue-50 dark:bg-blue-900/30 border-blue-200 dark:border-blue-700 text-blue-900 dark:text-blue-100" />
