...
<head>
    <meta charset="utf-8">
    <title>Daily Buy Report - {{ $date }}</title>
    <style>
        @page {
            margin: 1cm;
            size: A4 landscape;
...
<body>
    <div class="header">
        ...
        <div class="report-title">DAILY BUY REPORT</div>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th width="8%" class="text-right">Tare Wt.</th>
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="10" style="text-align: center; padding: 20px;">No buyes found for this date.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
    ...
    @if($buy_receipts->count() > 0)
        <div class="summary-box">
            ...
            <div class="summary-row" style="border-top: 1px solid #111827; margin-top: 5px; padding-top: 5px;">
                ...
                <span class="summary-value">{{ number_format($buy_receipts->sum('net_weight')) }} KG</span>
            </div>
        </div>
    @endif
