...
<head>
    <meta charset="utf-8">
    <title>Vehicle Summary - {{ $month }}</title>
    <style>
        @page {
            margin: 1cm;
            size: A4 portrait;
...
<body>
    <div class="header">
        ...
        <div class="report-title">MONTHLY VEHICLE SUMMARY</div>
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="4" style="text-align: center; padding: 20px;">No buys found for this month.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
