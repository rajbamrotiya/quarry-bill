...
<head>
    <meta charset="utf-8">
    <title>BuyReceipt #{{ $buy_receipt->id }}</title>
    <style>
        @page {
            margin: 0;
        }
        ...
        .supplier .copy-pill { background: #047857; }
        ...
        .supplier .net-weight-cell { background: #047857; }
        ...
        .supplier .dot { background: #047857; }
...
<body>
    @foreach([
        ...
        ['class' => 'supplier', 'label' => 'SUPPLIER COPY'],
        ['class' => 'transport', 'label' => 'TRANSPORT COPY']
    ] as $copy)
        <div class="buy_receipt-container">
            <x-buy_receipt-slip
